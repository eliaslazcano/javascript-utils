...
const removerAcentos = (texto, rigoroso = false) => {
  if (rigoroso) {
    return texto.normalize('NFD').replace(/[\u0300-\u036f]/g, '');
  }
  const acentosMap = new Map([['A', 'Á|À|Ã|Â|Ä'], ['a', 'á|à|ã|â|ä'], ['E', 'É|È|Ê|Ë'], ['e', 'é|è|ê|ë'], ['I', 'Í|Ì|Î|Ï'], ['i', 'í|ì|î|ï'], ['O', 'Ó|Ò|Ô|Õ|Ö'], ['o', 'ó|ò|ô|õ|ö'], ['U', 'Ú|Ù|Û|Ü'], ['u', 'ú|ù|û|ü'], ['C', 'Ç'], ['c', 'ç'], ['N', 'Ñ'], ['n', 'ñ']]);
...
const validarCPF = cpf => {
  ...
  const invalidCpfPatterns = ['00000000000', '11111111111', '22222222222', '33333333333', '44444444444', '55555555555', '66666666666', '77777777777', '88888888888', '99999999999'];
...
const encurtarNome = (fullname, useSecondName = false) => {
  ...
  if (useSecondName && secondName) return firstName + ' ' + secondName;else return firstName + ' ' + lastName;
};
...
const nomeSiglas = nome => {
  ...
  if (names.length === 1) return names[0].substr(0, 2);else return names[0].substr(0, 1) + names[names.length - 1].substr(0, 1);
};
