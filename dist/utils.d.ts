...
export function formatarCpfCnpj(cpfCnpj: any): any;
...
export function removerExtensao(nomeArquivo: any): string;
export function base64Decode(encodedString: any): string;
